...
@section('content')
    <div class="text-center">
        ...
        <div class="d-flex justify-content-center">
            <img class="img-fluid mb-3 rounded" src="https://ztbemybejhgwbftpryqs.supabase.co/storage/v1/object/public/invengo2/upload/{{ $data->image }}" alt="{{ $data->name }}" class="rounded mb-3" width="350" height="230">
        </div>
